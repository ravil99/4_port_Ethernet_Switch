// Данный модуль является сборкой всей "логики" работы коммутатора
// Для успешного синтеза в Quartus в модуле MAC_table параметр
...
module top_level
	...
	wire [$clog2(pPORT_WIDTH)-1:0]      		w_port_num_MAC [pPORT_WIDTH-1:0];		//Квартус это хавает вроде, а моделсим - нет
...
//		.o_read_request					(fifo_read_req_2)
    ...
    (
	.iclk                   		(i_clk),             
	.i_newSA_and_DA           ({wnewDA_3,wnewDA_2,wnewDA_1,wnewDA_0,wnewSA_3,wnewSA_2,wnewSA_1, wnewSA_0}),
